 ...
 * @returns { hash, fee }
 */
/** Poll for a tx receipt — robust against ethers' waitForTransaction stalling on instant-mining nodes. */
export async function waitMined (provider, hash, tries = 120) {
